...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { description: @discount.description, name: @discount.name, photo: @discount.photo, teather_id: @discount.teather_id }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { description: @discount.description, name: @discount.name, photo: @discount.photo, teather_id: @discount.teather_id }
    assert_redirected_to discount_path(assigns(:discount))
  end
