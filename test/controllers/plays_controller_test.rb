...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { description: @play.description, name: @play.name, photo: @play.photo, place: @play.place, price: @play.price, teather_id: @play.teather_id }
    end
  ...
  test "should update play" do
    patch :update, id: @play, play: { description: @play.description, name: @play.name, photo: @play.photo, place: @play.place, price: @play.price, teather_id: @play.teather_id }
    assert_redirected_to play_path(assigns(:play))
  end
